"""------------------------------------  Restraunt System Mangement mymu xx -----------------------------------------------"""
...
def CostofItems():
    ...
    SubTotalofITEMS = "EGP "+ str(round(PriceofFood + PriceofCakesandDrinks + 0.15))
    SubTotal.set(SubTotalofITEMS)

    Tax = "EGP "+ str(round((PriceofFood + PriceofCakesandDrinks + 0.15)*0.05))
    PaidTax.set(Tax)
    TT = ((PriceofFood + PriceofCakesandDrinks + 0.15)*0.05)
    TC = "EGP "+ str(round((PriceofFood + PriceofCakesandDrinks + 0.15) + TT))
    print((TC))
    TotalCost.set(TC)
